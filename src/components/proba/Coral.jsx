...
Source: https://sketchfab.com/3d-models/animated-undersea-scene-fish-submarine-coral-614590f43c254afdbef617f11fe19e30
Title: Animated Undersea Scene Fish Submarine Coral
*/
...
const Coral = (props) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/models/proba/coral.glb");
        ...
        >
          <group name='root'>
            <group name='GLTF_SceneRootNode' rotation={[Math.PI / 2, 0, 0]}>
              ...
              <group
                name='School_of_fish_159'
                position={[-1.081, 2.448, 0]}
                scale={0.118}
              >
              ...
              >
                <group name='RootNode0_152'>
                  <group name='sub_Mesh1_153' scale={0.01}>
                    <group
                      name='import12Submarine_UV2_154'
                      position={[0, 29.419, -25.659]}
                    >
...
useGLTF.preload("/models/proba/coral.glb");
