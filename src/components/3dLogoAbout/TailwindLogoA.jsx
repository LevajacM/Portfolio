...
const TailwindLogoA = (props) => {
  const { nodes, materials } = useGLTF("/models/logos/tailwind-h5.glb");
...
useGLTF.preload("/models/logos/tailwind-h5.glb");

export default TailwindLogoA;
