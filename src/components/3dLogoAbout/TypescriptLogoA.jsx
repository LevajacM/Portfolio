...
const TypescriptLogoA = (props) => {
  const { nodes, materials } = useGLTF("/models/logos/typescript-h5.glb");
...
useGLTF.preload("/models/logos/typescript-h5.glb");

export default TypescriptLogoA;
