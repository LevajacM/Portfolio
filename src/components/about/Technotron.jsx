...
const Technotron = (props) => {
  ...
  useEffect(() => {
    if (actions) {
      // Prvo proveravamo koje animacije imamo u GLTF modelu
      // console.log(actions); //ispisati sve dostupne animacije
      const action = actions[Object.keys(actions)[0]]; // Uzimamo prvu animaciju
      action.play(); // Pokrećemo animaciju
    }
  }, [actions]);
